...
export const getFollowersData = async (
  ...
  try {
    const response = await api.get(`/statistics/user/${userId}/followers`, {
      params: { timeframe }
    });
...
export const getPostsData = async (
  ...
  try {
    const response = await api.get(`/statistics/user/${userId}/posts`, {
      params: { timeframe }
    });
...
export const getTopPosts = async (
  ...
  try {
    const response = await api.get(`/statistics/post/${userId}/top`, {
      params: { limit }
    });
...
export const getPostsByDay = async (
  ...
  try {
    const response = await api.get(`/statistics/post/${userId}/byday`);
...
export const getEngagementByType = async (
  ...
  try {
    const response = await api.get(`/statistics/user/${userId}/engagement-types`, {
      params: { timeframe }
    });
...
export const getRecentActivity = async (
  ...
  try {
    const response = await api.get(`/statistics/user/${userId}/activity`, {
      params: { limit }
    });
